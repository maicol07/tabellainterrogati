  ...
  <nav>
    <div class="nav-wrapper">
      ...
      <ul class="right hide-on-med-and-down">
		...
		<li><a href="area_riservata/index.php"><i class="material-icons right">input</i>Area riservata</a></li>
      </ul>
      <ul class="side-nav" id="mobile-demo">
        <li><a href="https://github.com/maicol07/tabellainterrogati">Pagina del progetto</a></li>
        <li><a href="https://github.com/maicol07/tabellainterrogati/issues">Segnala un problema e/o richiedi una funzionalità</a></li>
		<li><a href="area_riservata/index.php"><i class="material-icons left">input</i>Area riservata</a></li>
      </ul>
    </div>
  </nav>
...
<table border="1"; class="responsive-table striped center">
		<thead>
		<tr>
...
<p><small>Creatore: <a href="http://www.github.com/maicol07">Battistini Maicol</a>
